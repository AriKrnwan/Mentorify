...
const Footer = () => {
    return (
      <footer className="wrapper-footer d-flex flex-column align-items-center p-2 gap-4 mt-5" style={{ fontFamily: "Poppins", fontWeight: "600", fontSize: "16px" }}>
        <div className="d-flex flex-column align-items-center p-2 gap-4 mt-5">
          <svg xmlns="http://www.w3.org/2000/svg" width="1437" height="150" viewBox="0 0 1437 150" fill="none">
            <path
              fill-rule="evenodd"
              clip-rule="evenodd"
